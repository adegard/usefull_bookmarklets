...
div2.innerHTML = '<form action="https://google.com/" target="_blank" onsubmit="if (Blummy.settings.close_blummlet) Blummy.close()">  <input type="hidden" name="jump" value="doclose" class="hidden" />  <table>  <tr><td>url</td><td>' + ((location.href.length > 50) ? location.href.substr(0, 50) + '...' : location.href) + '<input type="hidden" name="url" value="' + location.href + '" style="display: none" /></td></tr>  <tr><td>title</td><td><input type="text" name="description" value="' + document.title + '" class="text" /></td></tr>  <tr><td>tags</td><td><input type="text" name="tags" value="" class="text" /></td></tr>  <tr><td>notes</td><td><input type="text" name="extended" value="" class="text" /></td></tr>  <tr><td></td><td><input type="submit" value="store"/></td></tr>  </table>  </form>';
