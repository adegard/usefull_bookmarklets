...
a = document.createElement('a');
a.href = 'javascript:Blummy.href(\"http://www.alexa.com/data/details/traffic_details?q=&url=\"+location.hostname)';
a.title = 'javascript:Blummy.href(\"http://www.alexa.com/data/details/traffic_details?q=&url=\"+location.hostname)';
a.onmousedown = Blummy.storeSelection;
a.onclick = Blummy.close;
a.innerHTML = '';
if (document.all) {
a.innerHTML += '<img src="https://blummy.com/icon.php?id=2" alt="Alexa SiteInfo" style="margin-right: 3px; width: 16px; height: 16px" />';
} else {
...
this.div.appendChild(div);
div = document.createElement('div');
div.id = '__blummy_4_part';
div.className = 'part';
div.style.top = '75px';
div.style.left = '5px';
div.style.zIndex = 1;
div.title = '\' + document.links.length + \'';
div.innerHTML = '';
div.innerHTML += '<b>Links: </b>';
div.innerHTML += '' + document.links.length + '';
this.div.appendChild(div);
div = document.createElement('div');
div.id = '__blummy_8_part';
div.className = 'part';
div.style.top = '10px';
